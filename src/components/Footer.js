...
const Footer = () => {
  ...
  <div class="flex justify-center items-center lg:justify-between p-6 border-b border-black">
    ...
    <div class="flex justify-center">
      <a href="https://www.facebook.com/scientyficworld/" class="mr-6 text-gray-600">
      ...
      <a href="https://www.linkedin.com/company/scientyficworldorg/" class="mr-6 text-gray-600">
    ...
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div class="">
        <div class="
            ...
            md:justify-start
          ">
          <a href="https://scientyficworld.org" className="flex flex-row items-center">
      ...
      <div class="">
        ...
        <p class="mb-4">
          <a href="https://scientyficworld.org/privacy-policy/" class="text-gray-600">Privacy Policy</a>
        </p>
        <p class="mb-4">
          <a href="https://scientyficworld.org/terms-and-conditions/" class="text-gray-600">Terms and Conditions</a>
        </p>
      </div>
      <div class="">
        ...
        <p class="mb-4">
          <a href="https://scientyficworld.org/" class="text-gray-600">Home</a>
        </p>
        <p class="mb-4">
          <a href="https://scientyficworld.org/blog/" class="text-gray-600">Blog</a>
        </p>
        <p class="mb-4">
          <a href="https://scientyficworld.org/snehasish-konger/" class="text-gray-600">About</a>
        </p>
        <p>
      ...
      <div class="">
        ...
        <p class="flex items-center justify-center md:justify-start mb-4">
          <a href="mailto:support@scientyficworld.org" class="flex items-center justify-center md:justify-start mb-4">
