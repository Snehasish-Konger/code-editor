...
const Footer = () => {
  return (
    <footer className="text-center border-t border-black lg:text-left mt-6 text-gray-600">
  <div className="flex justify-center items-center lg:justify-between p-6 border-b border-black">
    <div className="mr-12 hidden lg:block">
      <span>Get connected with us on social networks:</span>
    </div>
    <div className="flex justify-center">
      <Link to="https://www.facebook.com/scientyficworld/" className="mr-6 text-gray-600">
      ...
      <Link to="https://www.linkedin.com/company/scientyficworldorg/" className="mr-6 text-gray-600">
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="">
        ...
        <p className="mb-4">
          <Link to="https://scientyficworld.org/privacy-policy/" className="text-gray-600">Privacy Policy</Link>
        </p>
        <p className="mb-4">
          <Link to="https://scientyficworld.org/terms-and-conditions/" className="text-gray-600">Terms and Conditions</Link>
        </p>
      </div>
      <div className="">
        <h6 className="uppercase font-semibold mb-5 flex justify-center md:justify-start">
          Useful links
        </h6>
        <p className="mb-4">
      ...
      <div className="">
        ...
        <p className="flex items-center justify-center md:justify-start mb-4">
          <Link to="mailto:support@scientyficworld.org" className="flex items-center justify-center md:justify-start mb-4">
  ...
  <div className="text-center p-2 border-t border-black">
    ...
    <Link className="text-gray-600 font-semibold" to="https://scientyficworld.org">Scientyfic World</Link>
  </div>
</footer>
  );
};
